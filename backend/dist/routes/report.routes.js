...
router.get('/transactions', (0, permission_middleware_1.permissionMiddleware)('VIEW_REPORT', 'REPORT'), (req, res) => report_controller_1.reportController.getTransactions(req, res));
