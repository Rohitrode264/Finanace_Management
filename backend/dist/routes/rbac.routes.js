...
// ── User Management ───────────────────────────────────────────────────────────
router.get('/users', (0, permission_middleware_1.permissionMiddleware)('MANAGE_USERS', 'USER'), (req, res) => rbac_controller_1.rbacController.listUsers(req, res));
router.post('/users', (0, permission_middleware_1.permissionMiddleware)('MANAGE_USERS', 'USER'), (req, res) => rbac_controller_1.rbacController.createUser(req, res));
