...
router.get('/transactions', permissionMiddleware('VIEW_REPORT', 'REPORT'), (req, res) => reportController.getTransactions(req, res));
router.get('/eagle-eye', permissionMiddleware('VIEW_REPORT', 'REPORT'), (req, res) => reportController.getEagleEye(req, res));
